...
for: FOR '('italz ';' cond ';' count')' '{' s '}' {int count_flag=0; int cond_flag=0;
						   if(l[op[1]]==1)
						     cond_flag=1;
						   if(d[2]==1)
						   {
