...
output_frame = ctk.CTkFrame(root, corner_radius=15, fg_color=input_bg_color)
...
error_frame = ctk.CTkFrame(root, corner_radius=15, fg_color=input_bg_color)
error_frame.grid(row=2, column=1, padx=10, pady=10, sticky="nsew")

error_label = ctk.CTkLabel(error_frame, text="Errors:", font=("Consolas", 18, "bold"), text_color=text_color)
error_label.pack(anchor="w", padx=10, pady=(10, 5))

error_textbox = ctk.CTkTextbox(error_frame, font=("Consolas", 16), wrap=tk.WORD, corner_radius=12, height=10, width=50, fg_color=error_bg_color)
error_textbox.pack(expand=True, fill="both", padx=10, pady=10)

button_frame = ctk.CTkFrame(root, corner_radius=15, fg_color=bg_color)
